...
export default function Navbar({ onViewTeams, onViewServices, onViewContact }) {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-50 bg-secondary/90 backdrop-blur-md shadow-lg overflow-x-hidden">
        <Container>
          <div className="py-4 px-4 flex items-center justify-between">
            <div className="flex gap-2 items-center">
              ...
              <div>
                ...
                <h1 className="text-accent text-xs">PT. DSA INDO CONSULTING</h1>
              </div>
            </div>

            <div className="hidden md:flex space-x-8">
              <button className="cursor-pointer text-lightText hover:text-accent transition">
                Our Teams
              </button>
              <button className="cursor-pointer text-lightText hover:text-accent transition">
                Our Services
              </button>
              <button className="px-4 py-2 rounded-full bg-accent text-secondary font-medium hover:bg-primary hover:text-lightText transition">
                Contact Us
              </button>
            </div>
