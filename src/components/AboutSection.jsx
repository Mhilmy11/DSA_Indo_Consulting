...
export default function AboutSection({ aboutRef, onViewServices }) {
  return (
    <div ref={aboutRef} className="py-16 md:py-28 font-sans overflow-x-hidden">
      <Container>
        <div className="mx-1 px-6 md:px-10 py-14 bg-gradient-to-br from-secondary via-[#052E70] to-primary rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center pt-20">
            <FramerMotion animation="zoom-in">
              <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-lg">
                ...
                <button
                  ...
                  className="bg-gradient-to-l from-[#5EEAD4] via-[#818CF8] to-[#3B82F6] px-5 py-3 rounded-lg hover:scale-105 transition"
                >
                  See Our Service
                </button>
              </div>
