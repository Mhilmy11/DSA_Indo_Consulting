...
export default function Hero({ onViewAbout }) {
  return (
        ...
        <div className=" px-4 grid grid-cols-1 md:grid-cols-2 items-center gap-10">
          <div className="">
            ...
            <div className=" flex gap-4 font-semibold text-lightText">
              <button className=" bg-gradient-to-r from-[#64FFDA] to-[#3B82F6] rounded-full px-4 py-2 cursor-pointer hover:scale-105 transition duration-300">
                Talk to an Expert
              </button>
              <button
                onClick={onViewAbout}
