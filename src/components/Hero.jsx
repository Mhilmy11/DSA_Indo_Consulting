...
export default function Hero({ onViewAbout, onViewContact }) {
  return (
    <div className="pt-32 pb-20 md:pb-40 font-sans overflow-x-hidden">
      <Container>
            ...
            <FramerMotion animation="fade-left">
              ...
              <div className="flex gap-4 font-semibold text-lightText">
                <button
                  ...
                  className="bg-gradient-to-r from-[#64FFDA] to-[#3B82F6] rounded-full px-4 py-2 hover:scale-105 transition"
                >
                  Talk to an Expert
                </button>
                ...
                <button
                  onClick={onViewAbout}
                  className="border border-gray-700 rounded-full px-4 py-2 hover:scale-105 transition"
                >
                  Learn More
                </button>
              </div>
